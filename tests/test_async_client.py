"""Unit tests for async employee API client."""
...
class TestAsyncEmployeeClient:
    """Tests for AsyncEmployeeClient."""
    ...
    def mock_token_client(self) -> MagicMock:
        """Create a mock async token client."""
        mock = MagicMock(spec=AsyncTokenClient)
        mock.get_access_token = AsyncMock(return_value="test_token")
    ...
    @pytest.mark.asyncio
    async def test_fetch_employees_success(
        self,
        settings: Settings,
    ...
    @pytest.mark.asyncio
    async def test_fetch_employees_uses_access_token_header(
        self,
        settings: Settings,
        mock_token_client: MagicMock,
        sample_employees: list[dict],
    ...
    @pytest.mark.asyncio
    async def test_fetch_employees_handles_empty_list(
        self,
        settings: Settings,
        mock_token_client: MagicMock,
        httpx_mock: HTTPXMock,
    ...
    @pytest.mark.asyncio
    async def test_fetch_employees_skips_malformed_records(
        self,
        settings: Settings,
        mock_token_client: MagicMock,
        httpx_mock: HTTPXMock,
    ...
    @pytest.mark.asyncio
    async def test_fetch_employees_handles_token_expiry(
        self,
        settings: Settings,
        sample_employees: list[dict],
        httpx_mock: HTTPXMock,
        ...
        mock_token_client = MagicMock(spec=AsyncTokenClient)
        mock_token_client.get_access_token = AsyncMock(
            side_effect=["expired_token", "fresh_token"]
        )
        mock_token_client.clear_cache = MagicMock()
    ...
    @pytest.mark.asyncio
    async def test_fetch_employees_with_unknown_fields(
        self,
        settings: Settings,
        mock_token_client: MagicMock,
        httpx_mock: HTTPXMock,
    ...
    @pytest.mark.asyncio
    async def test_fetch_employees_retry_on_error(
        self,
        settings: Settings,
        mock_token_client: MagicMock,
        sample_employees: list[dict],
    ...
    @pytest.mark.asyncio
    async def test_fetch_employees_handles_non_list_response(
        self,
        settings: Settings,
        mock_token_client: MagicMock,
        httpx_mock: HTTPXMock,
